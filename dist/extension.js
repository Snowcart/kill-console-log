...
const acorn_1 = __importDefault(__webpack_require__(2));
const acorn_walk_1 = __importDefault(__webpack_require__(3));
// This method is called when your extension is activated
// Your extension is activated the very first time the command is executed
function activate(context) {
    // Use the console to output diagnostic information (console.log) and errors (console.error)
    // This line of code will only be executed once when your extension is activated
    console.log('Congratulations, your extension "kill-console-log" is now active!');
    // The command has been defined in the package.json file
    // Now provide the implementation of the command with registerCommand
    // The commandId parameter must match the command field in package.json
    let disposable = vscode.commands.registerCommand("kill-console-log.helloWorld", () => {
        // The code you place here will be executed every time your command is executed
        // Display a message box to the user
        vscode.window.showInformationMessage("Hello VS Codezzzz!");
    });
    const killCommand = vscode.commands.registerCommand("kill-console-log.kill", kill);
    const decimate = vscode.commands.registerCommand("kill-console-log.decimate", () => {
        vscode.window.showInformationMessage("Decimated all Console Logs in Git Changes");
    });
    const eradicate = vscode.commands.registerCommand("kill-console-log.eradicate", () => {
        vscode.window.showInformationMessage("Eradicated all Console Logs in the workspace");
    });
...
const kill = () => {
    ...
    try {
        const ast = acorn_1.default.parse(text, { ecmaVersion: 2020, sourceType: "module" });
    ...
    vscode.window.showInformationMessage("Killed all Console Logs in current file");
};
